...
class InterviewContentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('interview_contents')->delete();
        
        \DB::table('interview_contents')->insert(array (
            0 => 
            array (
                'id' => 1,
                ...
                'image' => 'interview-contents/June2020/7alobpFW3RcWRjF3pR53.jpg',
                'meta_description' => 'Descrição SEO',
                'seo_title' => 'Título de SEO',
                'created_at' => '2020-06-22 21:01:11',
                'updated_at' => '2020-06-22 21:01:11',
            ),
        ));
